...
class CharacterInsertIntoDatabaseTest {
    ...
    void setUp() {
        ...
        character = new Character(stats, charname,level,clas);
    ...
    void insertedHasLevel(){
        ...
        for (Character insertCharacter : characterArrayList) {
            if (insertCharacter.getName().equals(charname) && insertCharacter.getLevel() == level) {
                testInsert = true;
            }
        }
        assertTrue(testInsert);
